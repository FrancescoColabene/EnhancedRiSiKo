...
protected:
	...
	void setWindowParameters() {
		...
		uniformBlocksInPool = 10; // prima era 9
		texturesInPool = 8;
		setsInPool = 10; // prima era 9
	...
	void localInit() {
		...
		VMonoColor.init(this, { {0, sizeof(VertexMonoColor), VK_VERTEX_INPUT_RATE_VERTEX } },
			{
